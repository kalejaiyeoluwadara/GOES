  ...
  return (
    <div className="items-start pt-8 pl-6 bg-gray-300 h-screen">
      ...
      <div className="flex flex-col">
        {[1, 2, 3, 4, 5].map((d, id) => {
          return (
            <main className="w-screen border-y cursor-pointer border-gray-400 text-gray-600 grid grid-cols-3 justify-center px-8 items-center bg-gray-200 shadow-md h-[80px]">
